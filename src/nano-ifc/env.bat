...
:: the .env file should contain a line like this (important to use forward slashes / instead of backslashes \).
:: PREFIX=C:/Users/your_user_name/mambaforge3/envs/ada-cpp
for /f "tokens=*" %%i in (%THIS_DIR%.env) do set %%i
if not defined PREFIX (
    echo "You have to add a .env file to the root of the project where you set PREFIX=<path to your ada-cpp conda env>"
